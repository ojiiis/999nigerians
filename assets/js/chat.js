    ...
    let    list = `<a class="pc-lister" id="list-${data.list_id}" href="javascript:void(0)" onclick="cb_show(this)" data-id="${data.list_id}"><div class="avi" style="background-image:url('https://lin.com.ng/love/media/${data.avi}');background-size:cover;background-position:center"></div>
                        <div class="details">
  ...
  if(method.toLowerCase() == "get"){
   ...
   uiR("https://lin.com.ng/love/emapi/messages/up","POST",{
     ...
     uiR("https://lin.com.ng/love/emapi/seen",'POST',{
         ...
         function listen(){
             ...
             if(localStorage.getItem("opened-chat") == null || localStorage.getItem("opened-chat") == ""){
                     ...
                     uiR("https://lin.com.ng/love/emapi/live-messages", "POST", {
                ...
                uiR("https://lin.com.ng/love/emapi/new-messages","POST",{
                    "cid":opened
                }).then(data=>{
                    if(data.status == 1){
               let msgs = loadchat(data.data);
